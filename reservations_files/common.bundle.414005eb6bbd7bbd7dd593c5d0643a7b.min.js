...
window.AWIX.setWidgetCss = function(compId, css, setChildCss) {
  Wix.PubSub.publish("asdk", {"method": "setWidgetCss", "compId": compId, "setChildCss": setChildCss || false, "css": css}, true);
};

window.AWIX.setViewportContent = function(content) {
  Wix.PubSub.publish("asdk", {"method": "setViewportContent", "content": content}, true);
};
